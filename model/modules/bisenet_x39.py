...
from .xception import xception39
...
class BiSeNet(nn.Module):
    def __init__(self, out_planes, output_size, is_training=False,
        ...
        if norm_layer == 'bn':
            ...
            raise RuntimeError('Undefined Norm Type')
    ...
    def forward(self, data, label=None):
        ...
        result = F.interpolate(self.heads[-1](pred_out[-1]),
                               self.output_size,
                               mode='bilinear',
                               align_corners=True)
